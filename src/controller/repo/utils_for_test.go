...
// injectMockAssetContext injects general asset context into a request
func injectMockQueryAssetContext(r *http.Request, query interface{}, filter interface{}, limit interface{}, skip interface{}) (reqWithContext *http.Request) {
	...
	reqWithContext = r.WithContext(context.WithValue(r.Context(), "assetQueryVars", vars))
	return
}
